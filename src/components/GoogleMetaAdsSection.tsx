      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 text-center">
            ...
            <FormModal>
              <Button size="lg" className="px-8 py-4 text-lg font-bold bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 shadow-xl hover:shadow-primary/30 hover:scale-105 transition-all duration-300 text-black">
                Quero Crescer Agora
              </Button>
            </FormModal>
          </div>
