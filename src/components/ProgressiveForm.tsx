          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <Input
                ...
                className="text-lg py-4 h-14 bg-background/50 border-border/50 focus:border-primary focus:ring-primary/20"
                autoFocus
              />
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <Button
                  onClick={handleNext}
                  className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 rounded-full flex items-center space-x-2 shadow-glow hover:shadow-glow/60 transition-all duration-300"
                >
                  <span>
